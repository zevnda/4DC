        ...
        switch (options.getString('data')) {
                ...
                channel.createWebhook({ name: client.user.username, avatar: `${avatarURL}` }).then(webhook => {
                    webhook.send({
                        embeds: [new EmbedBuilder()
                            ...
                            .setDescription('By participating in this server, you agree to the following')
                            .setColor('#2B2D31')
                ...
                channel.createWebhook({ name: client.user.username, avatar: `${avatarURL}` }).then(webhook => {
                    webhook.send({
                        embeds: [new EmbedBuilder()
                            ...
                            .setDescription('A detailed list of all the server\'s channels and roles')
                            .setColor('#2B2D31')
            ...
            case 'faqs': {
                ...
                channel.createWebhook({ name: client.user.username, avatar: `${avatarURL}` }).then(webhook => {
                    webhook.send({
                        embeds: [new EmbedBuilder()
                            .setTitle('FAQ & USEFUL LINKS')
                            .setDescription('A compilation of frequently asked question and useful links')
                            .setColor('#2B2D31')
